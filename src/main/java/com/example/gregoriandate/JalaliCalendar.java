...
public class JalaliCalendar extends Calendar {
    ...
    public static String getJalaliDateAndTime(Date gDate) {
        ...
        String jalali = jDate.year + "/" + month + "/" + day + "  " + String.format("%02d", gDate.getHours()) + ":" +  String.format("%02d", gDate.getMinutes()) ;
        return jalali;
    }
    ...
    public static String getJalaliDate(Date gDate) {
        ...
        String jalali = jDate.year + "/" + month + "/" + day ;
        return jalali;
    }
